...
class Contact extends React.Component {
  ...
  componentDidMount() {
    ...
    ReactGa.pageview('frisonsistemas.net - Contact Screen');
  }
   //--Hellen Morgans Portfolio website Google analytics--
  ...
  render() {
    return (
      <div>
        <Helmet>
                <meta charSet="utf-8" />
                <title>Contact | Hellen Morgan</title>
                <link rel="canonical" href="https://frisonsistemas.net/contact" />
                <meta name="description" content="Hellen Morgan | Contact - Product Manager | Project Manager | Software Engineer" />
        </Helmet>
