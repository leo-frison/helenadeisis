...
function Analytics(){
  ...
  ReactGa.pageview('frisonsistemas.net - Home Screen')
}
//--Hellen Morgans Portfolio website Google analytics--
...
function Home() {
  ...
  return (
      <div>
         <Helmet>
                  <meta charSet="utf-8" />
                  <title>Home | Hellen Morgan</title>
                  <link rel="canonical" href="https//miblog.com" />
                  <meta name="description" content="Hellen Morgan | " />
         </Helmet>
