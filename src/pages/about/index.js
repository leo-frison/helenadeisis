...
class About extends Component {
  ...
  componentDidMount() {
    ...
    ReactGa.pageview('frisonsistemas.net - About Screen');
    //--Hellen Morgans Portfolio website Google analytics--
  }
  ...
  render() {
    return (
        <Container className="About-header" fluid={true}>
          <Helmet>
                <meta charSet="utf-8" />
                <title>About | Hellen Morgan</title>
                <link rel="canonical" href="https://frisonsistemas.net/about" />
                <meta name="description" content="Hellen Morgan | About - Product Manager | Project Manager | Software Engineer
